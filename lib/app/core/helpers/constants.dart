...
class Constants {
  ...
  static const REST_CLIENT_RECEIVE_TIMEOUT = 'rest_client_receive_timeout';


  static const LOCAL_STORAGE_ACCESS_TOKEN_KEY = '/LOCAL_STORAGE_ACCESS_TOKEN_KEY/';
  static const LOCAL_STORAGE_REFRESH_ACCESS_TOKEN_KEY = '/LOCAL_STORAGE_REFRESH_ACCESS_TOKEN_KEY/';
  static const LOCAL_STORAGE_USER_LOGGED_DATA_KEY = '/LOCAL_STORAGE_USER_LOGGED_DATA_KEY';
  static const LOCAL_STORAGE_ADDRESS_DATA_KEY = '/LOCAL_STORAGE_ADDRESS_DATA_KEY/';
